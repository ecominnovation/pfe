...
{
    /**
     * $_dbTable - instance of Application_Model_DbTable_TableAbstract
     *
     * @var Application_Model_DbTable_TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Application_Model_DbTable_TableAbstract $dbTable
     ...
     *
     * @see Application_Model_DbTable_TableAbstract::countAllRows()
     ...
     *
     * @see Application_Model_DbTable_TableAbstract::countByQuery()
     ...
     *
     * @param Application_Model_ModelAbstract $model The model to delete
     * @return int
     */
    ...
    {
        $adapter = new Application_Model_Paginator($select, $this);
     ...
     * @return array All Application_Model_ModelAbstract meeting the criteria
     */
     ...
     * @param Application_Model_ModelAbstract|null $model
     * @return Application_Model_ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Application_Model_DbTable_TableAbstract
     */
     ...
     *
     * @param new Application_Model_ModelAbstract $model
     * @return array
     */
     ...
     * @param Application_Model_ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
